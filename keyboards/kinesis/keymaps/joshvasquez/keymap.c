...
[QWERTY] = LAYOUT(
           ...
           MT_ESC,CTL_T(KC_A),LGUI_T(KC_S),LALT_T(KC_D),SFT_T(KC_F) ,KC_G   ,
           KC_LSFT,CST_Z  ,KC_X   ,KC_C   ,KC_V   ,KC_B   ,
                   KC_GRV ,KC_TILD,KC_LEFT,KC_RGHT,
			   KC_LGUI,KC_LALT,
                                    KC_HOME,
                           LT(MMEDIA,KC_BSPC), LCTL17 ,LCA_T(KC_F17),
    KC_F9,KC_F10 ,KC_F11 ,KC_F12 ,KC_PSCR   ,KC_VOLD  ,KC_VOLU, TG(GAMING), RESET,
